...
In order to gain a wider understanding of our product, we decided to conduct a series of semi-structured interviews with a few end users to analyse the ethical issues surrounding our product, and our product’s impact on its stakeholders. This included analysing the possibility of the bots feeding social media addiction rather than helping to address it, and the bots generating offensive content. These are both issues linked to the interests of stakeholders in the UX Design chapter.

Interviewees were left to use the website for a period, and then asked questions about it. When asked whether they found any of the randomly generated posts offensive, all users answered they hadn’t seen anything that they found offensive. All users acknowledged the possibility of the generated text creating offensive sentences, but three of the four interviewees stated that they wouldn’t consider that a problem because they would see it as an ‘unfortunate’ product of the randomness rather than anything more serious. One user stated that although they didn’t find the posts offensive, then found them ‘antagonising’ because the bots were using words that they considered to be “politicised”. Examples of provocative terms given were “fat”, “4chan” and “anti-vaxxers”. However, this user also said that they saw the inclusion of these words as a response to the way that social media sites promote provocative material in order to drive engagement, which justified their inclusion. In contrast to other respondents, this user considered offensive content to be the responsibility of the makers of website, as the website builders had a choice over which words to include in the sentence database. They therefore had a responsibility for what was produced.

When asked whether they thought an offensive post generated by the site could perpetuate hateful behaviour or prejudice, the response was mixed. Most respondents acknowledged that it could be possible for a post to have that effect but indicated that they thought the impact was likely to be limited. One user suggested that any offensive post could “trivialise” offensive content. Others suggested that a post would have to be shared or condoned by a human user for it to gain meaning. Multiple respondents raised the case of ‘Tay’ the artificial intelligence chat bot and made the argument that Tay’s output was worse than the content created by our ‘bots’ because the trigger for Tay’s offensive output was real humans feeding her offensive example sentences. The conclusion of the majority of our test users therefore seemed to be that offensive content became a serious cause for concern once it was shared, created or condoned by humans (something that our site currently has no inherent functionality for).

Respondents expressed greater concern about users’ posts appearing anonymously on other users’ timelines at random. This was seen as having greater potential for offense, as unlike the bots, this content had ‘intent’. The unfiltered nature of these posts could also make the site an inappropriate place for young people, which could ultimately prevent a large proportion of our target audience from accessing the site.

The question of whether our site could perpetuate addictive behaviour rather than addressing it was largely dismissed by our respondents as either not an issue or a criticism which was in bad faith. Respondents commented that there was more addictive content to be found on the web, and that by its nature our site was priming its users to question the way they responded to the site. Respondents concluded that addictive elements were a justified feature of the site, and that critics would need to exaggerate the site’s potential damage in order accuse it of being ‘hypocritical’ in regard to addictiveness.

Other feedback received in relation to the ethics of the site was that the site should follow the Web Content Accessibility Guidelines in order to be more accessible for a diverse audience.

Consideration of this feedback would form a good basis for further work, as it is clear that although the possible negative impact of the site is somewhat limited, the site should do more to safeguard potential users and to be accessible for a wider proportion of possible users.
